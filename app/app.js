...
美单—该项目主要运用angularjs框架开发。（虽然用的是angularjs1，感觉运用的是angularjs2的思想）
其他卖家工具—聚网批，流量无忧等。
主要运用了gulp、grunt、less等工具和语言（现在这几个工具都很少用了）
...
在智客学到了很多东西，不管是工作知识还是在与他人沟通中。感觉后期公司很乏力，没有去尝试更多的业务就放弃了，公司成立子公司后，抽调了更多的人去做其他去了。
...
该项目是在第一个版本的基础上升级，第一版没有用任何框架，升级过后用的angularjs框架，不管是在性能和页面上面都有了很大的提升。
...
其实在这个公司呢！也没什么多少项目可说，毕竟是还没有毕业在实习期，公司在慢慢转型，技术人员相继离职。想想还是有点怀念呢  在短短的几个月里面，都是接触到的前端的pc端的项目。
这是为自己进入前端坑奠定了基础（=。=）
负责项目：工长汇、云舜、铭炜、鲜果蜗牛、官网等。
所用到框架：bootstrap，jquery等。

毕竟是带我踏进进入这个行业的公司，从此进入了前端坑。。。
通过接触到不同公司的不同项目，不管是pc还是移动端，不管是reactjs、angularjs等各种前端框架，一路踩过来的坑也不少，在兼容和性能等方面，正如刚刚接触到es6（熟悉），es7（学习中），还是最近刚接触到的typescript等，技术在不断更新，坑也在不断的踩中。。。
